...
const styles = StyleSheet.create({safe:{flex:1,backgroundColor:colors.bg},header:{height:76,paddingHorizontal:20,flexDirection:'row',alignItems:'center',justifyContent:'space-between'},back:{width:44,height:44,alignItems:'center',justifyContent:'center'},headerLabel:{color:colors.muted,fontSize:12,letterSpacing:1.3},content:{padding:20,paddingBottom:100},heroIcon:{width:76,height:76,borderRadius:20,backgroundColor:colors.raised,alignItems:'center',justifyContent:'center',marginBottom:24},eyebrow:{color:colors.mint,fontSize:11,letterSpacing:1.7,fontWeight:'800',marginBottom:12},title:{color:colors.text,fontSize:34,lineHeight:41,fontWeight:'700',letterSpacing:-.8,marginBottom:14},body:{color:colors.muted,fontSize:16,lineHeight:25,marginBottom:24},primary:{minHeight:56,borderRadius:12,backgroundColor:colors.mint,alignItems:'center',justifyContent:'center',marginTop:8},primaryText:{color:colors.bg,fontWeight:'800',fontSize:15},roomCard:{padding:18,borderWidth:1,borderColor:colors.line,borderRadius:20,backgroundColor:colors.surface,marginBottom:14},requestCard:{padding:16,borderWidth:1,borderColor:colors.line,borderRadius:18,marginBottom:12},requestActions:{flexDirection:'row',justifyContent:'flex-end',gap:20,marginTop:8},routeList:{marginTop:18,borderTopWidth:1,borderTopColor:colors.line},route:{minHeight:50,borderBottomWidth:1,borderBottomColor:colors.line,flexDirection:'row',alignItems:'center',justifyContent:'space-between'},fieldLabel:{color:colors.mint,fontSize:11,letterSpacing:1.4,fontWeight:'800',marginTop:18,marginBottom:8},input:{minHeight:50,borderRadius:14,borderWidth:1,borderColor:colors.line,backgroundColor:colors.raised,paddingHorizontal:14,color:colors.text,fontSize:15,marginBottom:8},multiline:{minHeight:104,paddingTop:12},reason:{minHeight:48,flexDirection:'row',alignItems:'center',justifyContent:'space-between',paddingHorizontal:12,borderWidth:1,borderColor:colors.line,borderRadius:12,marginBottom:8},reasonSelected:{borderColor:colors.mint,backgroundColor:'#292C20'},notice:{color:colors.mint,fontSize:14,lineHeight:20,marginTop:16},disclaimer:{color:colors.muted,fontSize:12,lineHeight:18,marginTop:16},routeText:{color:colors.text,fontSize:13,fontWeight:'700',letterSpacing:.5},secondary:{minHeight:54,borderRadius:16,backgroundColor:colors.raised,borderWidth:1,borderColor:colors.line,alignItems:'center',justifyContent:'center',marginTop:12},secondaryText:{color:colors.text,fontWeight:'700',fontSize:15}});
